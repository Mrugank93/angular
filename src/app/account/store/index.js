angular.module('account.cart', [  
   'account.cart.index',
   'account.cart.detail',
   'account.cart.shopcart' 
]);
...
angular.module('account.cart').factory("DataService", function () {
    ...
    myCart.addCheckoutParameters("PayPal", "twinklemevada-facilitator@jacksolutions.biz");
