angular.module('account.cart.detail', ['ngRoute', 'security.authorization', 'services.utility', 'services.accountResource', 'ui.bootstrap']);
angular.module('account.cart.detail').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/account/products/:id', {
      templateUrl: 'account/store/account-products.tpl.html',
      controller: 'accountEditShopDetailCtrl',
      title: 'Item / Details',
      resolve: {
...
angular.module('account.cart.detail').controller('accountEditShopDetailCtrl', ['$routeParams','$scope', '$route', '$location', '$log', 'utility', 'accountResource', 'ItemDetail','localStorageService','$routeParams','DataService',
