angular.module('account.cart.shopcart', ['ngRoute', 'security.authorization', 'services.utility', 'services.accountResource', 'ui.bootstrap']);
angular.module('account.cart.shopcart').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/account/store/cart', {
      templateUrl: 'account/store/account-cart.tpl.html',
      controller: 'AccountAddCartCtrl',
      title: 'Cart / Details',
      // resolve: {
...
angular.module('account.cart.shopcart').controller('AccountAddCartCtrl', ['$scope', 'DataService', '$routeParams',
