...
.factory('security', ['$http', '$q', '$location', 'securityRetryQueue', '$modal','localStorageService', function($http, $q, $location, queue, $modal,localStorageService) {
  //alert("security");
  ...
  var service = {
    ...
    signup: function(data){
      ...
      var request = $http.post('/api/signup',data);
    ...
    requestCurrentUser: function() {
      if ( service.isAuthenticated() ) {
        ...
        $http.get('/api/current-user').then(function(response){
          // console.log(response,localStorageService.get('user'));
